...
import 'package:travel_guidence_app/Screens/Screen2/see_around_detail%20screen.dart';
import '../model_h.dart';
...
class _PlacesToSeeAroundScreenListState extends State<PlacesToSeeAroundScreenList> {
  Future<List<Place>> fetchPlaces() async {
    try {
      final response = await http.get(Uri.parse('https://darshan7842.000webhostapp.com/Travel_guidence_app/around.php'));
