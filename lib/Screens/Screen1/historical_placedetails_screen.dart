...
class PlaceDetailsScreen extends StatelessWidget {
  ...
  Future<Place> fetchPlaceDetails() async {
    final url = 'https://darshan7842.000webhostapp.com/Travel_guidence_app/alfred.php?name=$placeName';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Place Details', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold)),
      ),
